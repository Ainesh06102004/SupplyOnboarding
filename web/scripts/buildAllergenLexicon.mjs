...
// food.ingredient_alias and food.ingredient_allergen. The storefront matches
...
const [families, ingredients, aliases, links] = await Promise.all([
...
const data = { FAMILIES, INGREDIENTS, ALIASES };
...
// food.ingredient_alias and food.ingredient_allergen. Do not edit by hand:
// change the graph in the database, then rebuild.
...
// [canonical name, [[allergen family, relation], ...]]
