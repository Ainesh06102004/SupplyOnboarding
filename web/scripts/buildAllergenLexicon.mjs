...
const [families, ingredients, aliases, links, flags] = await Promise.all([
...
// food.ingredient_alias, food.ingredient_allergen and food.ingredient_flag.
// Do not edit by hand: change the graph in the database, then rebuild.
